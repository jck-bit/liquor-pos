...
<div class="page">
  ...
  <div class="page-body">
    ...
    <p class="muted" style="margin-top: 12px">Cashiers can sell, receive deliveries and view reports. Owners can also edit products and prices, void sales, adjust stock, manage users and see the audit log.</p>
  </div>
</div>
